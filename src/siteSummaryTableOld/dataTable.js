...
import makeSiteSummaryData from './makeSiteSummaryData';
...
export default function dataTable() {
  ...
  const kriObj = SUMMARY_DATA.all_kris_list.map((kri) => (
    {
      ...
      // cell: (props) => <span>{siteSummaryTable.flagStatusIcon(props.getValue().flag_value, props.getValue())}</span>
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (props) => <span>{siteSummaryTable.flagStatusIcon(props.getValue(), props.getValue())}</span>
    },
    {
      header: "Amber kris",
