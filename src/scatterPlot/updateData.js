...
export default function updateData(chart, _data_, _config_, _bounds_) {
    ...
    chart.data.config.hoverEvent = addCustomHoverEvent(chart.canvas, chart.data.config.hoverCallback);
    chart.data.config.clickEvent = addCustomClickEvent(chart.canvas, chart.data.config.clickCallback);
