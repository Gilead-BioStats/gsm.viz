var gsmViz = (() => {
  ...
  function checkThresholds(_config_, _thresholds_, _flags_) {
  ...
  function configure3(_config_, _results_, _thresholds_, _flags_) {
    const defaults3 = {};
  ...
  function annotations(config) {
    const annotations5 = config.thresholds ? config.thresholds : null;
    return annotations5;
  }
  ...
  // src/barChart.js
  function barChart(_element_ = "body", _results_ = [], _config_ = null, _thresholds_ = null, _groupMetadata_ = null, _flags_ = null) {
    console.log(_flags_);
    checkInputs(_results_, _config_, _thresholds_, _groupMetadata_);
    const config = configure3(_config_, _results_, _thresholds_, _flags_);
